...
const ANIL_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  'Abomasnow': {bs: {df: 85, sd: 95}},
  'Alcremie': {abilities: {0: 'Well-Baked Body'}, otherFormes: ['Alcremie-Mega']},
  'Alomomola': {bs: {sa: 75}},
  'Altaria': {bs: {at: 90, sa: 90, sd: 95}, abilities: {0: 'Pixilate'}},
  'Altaria-Mega': {bs: {sa: 120, sp: 90}},
  'Appletun': {otherFormes: ['Appletun-Mega']},
  'Arbok': {types: ['Poison', 'Dark'], bs: {hp: 70, sp: 95}},
  'Arcanine-Hisui': {bs: {at: 125, sa: 85}},
  'Arctovish': {bs: {at: 115, df: 90, sa: 90, sd: 80}},
  'Arctozolt': {bs: {at: 115}},
  'Ariados': {bs: {hp: 85, at: 110, sd: 60, sp: 80}},
  'Audino': {bs: {hp: 80, sa: 90}},
  'Azumarill': {bs: {sa: 50}},
  'Baltoy': {bs: {sa: 60}},
  'Barbaracle': {bs: {at: 115, sa: 86, sd: 68, sp: 54}},
  'Barboach': {bs: {hp: 60, at: 65, sa: 65}},
  'Bastiodon': {bs: {hp: 70}},
  'Bayleef': {types: ['Grass', 'Fairy']},
  'Beautifly': {bs: {hp: 70, df: 60, sa: 110, sd: 75, sp: 85}},
  'Bellossom': {bs: {df: 85, sa: 100}},
  'Beedrill': {bs: {at: 100, sa: 65, sp: 95}},
  'Beheeyem': {bs: {df: 85}},
  'Bibarel': {bs: {hp: 90, df: 70, sa: 70, sd: 80}},
  'Boldore': {bs: {hp: 80, sd: 60}},
  'Bombirdier': {bs: {at: 113, df: 95}},
  'Bonsly': {bs: {sp: 50}},
  'Blacephalon': {bs: {at: 97, sa: 141, sd: 69}},
  'Blastoise': {otherFormes: ['Blastoise-Mega-X', 'Blastoise-Mega-Y']},
  'Blastoise-Mega-X': {types: ['Water'], bs: {hp: 79, at: 103, df: 120, sa: 135, sd: 115, sp: 78}, abilities: {0: 'Mega Launcher'}},
  'Blastoise-Mega-Y': {types: ['Water', 'Steel'], bs: {hp: 79, at: 93, df: 140, sa: 115, sd: 145, sp: 58}, abilities: {0: 'Shell Armor'}},
  'Blitzle': {abilities: {0: 'Reckless'}},
  'Brambleghast': {bs: {df: 80, sp: 100}},
  'Bruxish': {bs: {at: 110, sp: 100}},
  'Budew': {bs: {hp: 50, at: 50, sa: 55, sd: 60}},
  'Bunnelby': {bs: {at: 35}},
  'Butterfree': {bs: {sa: 100, sp: 90, sd: 100 }, otherFormes: ['Butterfree-Mega']},
  'Buzzwole': {bs: {hp: 97, at: 129, df: 119, sp: 89}},
  'Cacturne': {bs: {hp: 85}},
  'Camerupt' : {bs: {df: 80, sd: 85}, abilities: {0: 'Sheer Force'}},
  'Camerupt-Mega': {bs: {hp: 70, at: 120, df: 100, sa: 135, sd: 105, sp: 30}, abilities: {0: 'Sheer Force'}},
  'Capsakid': {bs: {hp: 52}},
  'Caterpie': {bs: {at: 40}},
  ...
  'Centiskorch': {otherFormes: ['Centiskorch-Mega']},
  'Chatot': {bs: {at: 90, df: 55, sa: 100, sd: 52, sp: 100}},
  'Cherrim': {bs: {sa: 100, sd: 88, sp: 100}},
  'Chesnaught': {bs: {hp: 100, at: 117, sa: 64}},
  'Chingling': {bs: {hp: 55, sd: 60}, abilities: {0: 'Tintineo'}},
  'Chimecho': {abilities: {0: 'Tintineo'}},
  'Chikorita': {types: ['Grass', 'Fairy']},
  'Claydol': {bs: {hp: 70, at: 60, sa: 90}},
  'Coalossal': {otherFormes: ['Coalossal-Mega']},
  'Corviknight': {otherFormes: ['Corviknight-Mega']},
  'Corsola': {bs: {hp: 85, at: 85, df: 85, sa: 95, sd: 85}},
  'Copperajah': {otherFormes: ['Copperajah-Mega']},
  'Cramorant': {bs: {sa: 95, sd: 85}},
  'Crustle': {bs: {df: 135}},
  'Cubone': {bs: {at: 70, sp: 55}},
  'Cufant': {bs: {sa: 49, sd: 40}},
  'Cyndaquil': {types: ['Fire', 'Normal']},
  'Decidueye': {bs: {sa: 80, sd: 85, sp: 105}},
  'Decidueye-Hisui': {bs: {sa: 85, df: 90}},
  'Dedenne': {bs: {sa: 100, sd: 85}, abilities: {0: 'Electric Surge'}},
  'Delcatty': {bs: {hp: 90, at: 95, df: 75, sa: 90, sd: 65, sp: 100}, abilities: {0: 'Pixilate'}},
  'Delibird': {bs: {hp: 65, at: 75, df: 65, sa: 100, sd: 65, sp: 90}},
  'Dewgong': {bs: {at: 90, sa: 90}},
  'Dewott': {types: ['Water', 'Fighting']},
  ...
  'Drizzile': {bs: {at: 50, sd: 50}},
  'Drowzee': {bs: {sa: 63}, abilities: {0: 'Run Away'}},
  'Ducklett': {bs: {sa: 64}},
  'Dugtrio': {bs: {hp: 65, df: 70} , otherFormes: ['Dugtrio-Alola']},
  'Dugtrio-Alola': {bs:{hp: 65, df: 70}},
  'Duskull': {bs: {at: 55}},
  ...
  'Espathra': {bs: {sd: 70}},
  'Exeggutor': {bs: {sd: 80}},
  'Exploud': {bs: {at: 100, sa: 100, sd: 63}},
  'Falinks': {abilities: {0: 'Skill Link'}},
  'Farfetch\u2019d': {bs: {hp: 85, at: 100, df: 75, sd: 85, sp: 95}, abilities: {0: 'Super Luck'}},
  'Fearow': {bs: {at: 115}, abilities: {0: 'Sniper'}},
  'Feebas': {bs: {hp: 50, at: 45, df: 35, sa: 60, sp: 70}},
  'Feraligatr': {types: ['Water', 'Dark']},
  'Finneon': {bs: {sa: 69}},
  Flabébé: {abilities: {0: 'Floración'}},
  'Floette': {abilities: {0: 'Floración'}},
  'Florges': {abilities: {0: 'Floración'}},
  'Flamigo': {bs: {sd: 74}},
  'Flapple': {otherFormes: ['Flapple-Mega']},
  'Flareon': {bs: {hp: 75, sa: 85}},
  'Floatzel': {bs: {at: 110}},
  'Flygon': {bs: {sa: 100, sp: 110}},
  'Froslass': {bs: {sa: 90}},
  'Frosmoth': {bs: {df: 65}},
  'Furfrou': {bs: {at: 90}},
  'Furret': {bs: {at: 90, sd: 65, sp: 110}, abilities: {0: 'Fur Coat'}},
  'Garbodor': {bs: {at: 115, sp: 60}, types: ['Poison', 'Steel'], otherFormes: ['Garbodor-Mega']},
  'Geodude': {bs: {hp: 50}},
  'Gengar': {otherFormes: ['Gengar-Mega-X', 'Gengar-Mega-Y']},
  'Gengar-Mega-X': {types: ['Ghost', 'Poison'], bs: {hp: 60, at: 75, df: 80, sa: 160, sd: 95, sp: 130}, abilities: {0: 'Shadow Tag'}},
  'Gengar-Mega-Y': {types: ['Ghost', 'Dark'], bs: {hp: 60, at: 95, df: 90, sa: 140, sd: 145, sp: 110}, abilities: {0: 'Perish Body'}},
  'Gigalith': {bs: {hp: 95}},
  'Glalie': {types: ['Ice', 'Dark'], bs: {hp: 90, at: 90, sa: 90}},
  'Golbat': {bs: {sp: 100}},
  'Golduck': {types: ['Water', 'Psychic'], bs: {at: 92}},
  'Golem': {bs: {hp: 110}},
  'Golisopod': {bs: {df: 110}},
  'Gourgeist-Small': {bs: {hp: 85, at: 100, sp: 54}},
  'Grafaiai': {bs: {at: 105}},
  'Granbull': {types: ['Fairy', 'Fighting']},
  'Graveler': {bs: {hp: 80}},
  'Grimer': {bs: {at: 60, sa: 60}},
  'Grimmsnarl': {otherFormes: ['Grimmsnarl-Mega']},
  'Grumpig': {bs: {df: 75, sa: 100}},
  'Gumshoos': {bs: {sp: 85}},
  'Gulpin': {bs: {sa: 53}, abilities: {0: 'Corrosion'}},
  'Gurdurr': {bs: {sa: 50}},
  'Guzzlord': {bs: {hp: 173}},
  'Hatterene': {otherFormes: ['Hatterene-Mega']},
  'Heatmor': {bs: {at: 110, df: 86, sa: 95, sd: 86}},
  'Heliolisk': {bs: {sa: 115}},
  'Hitmonchan': {bs: {hp: 60}},
  'Hitmonlee': {bs: {hp: 60}},
  'Hoothoot': {bs: {sa: 66}}, 
  ...
  'Hydrapple': {bs: {sa: 130}},
  'Hypno': {bs: {at: 80, sa: 95}, abilities: {0: 'Run Away'}},
  'Illumise': {types: ['Bug', 'Fairy'], bs: {at: 53, df: 55, sa: 95, sd: 100}},
  'Impidimp': {bs: {sa: 40, sd: 50}},
  'Jumpluff': {bs: {at: 90}},
  'Jynx': {bs: {sp: 105}, abilities: {0: 'Cute Charm'}},
  'Kakuna': {bs: {at: 65}},
  'Kartana': {bs: {at: 151, df: 111}},
  'Kecleon': {bs: {at: 100}},
  'Kingler': {bs: {hp: 75}, otherFormes: ['Kingler-Mega']},
  'Kirlia': {bs: {hp: 55, df: 45, sa: 75, sd: 75}},
  'Klawf': {bs: {hp: 80}},
  'Komala': {bs: {hp: 75}},
  'Krabby': {bs: {sa: 40, sd: 35}},
  'Kricketot': {bs: {at: 45, sa: 45}},
  'Kricketune': {bs: {at: 105, df: 61, sd: 86}},
  'Lampent': {bs: {at: 55, df: 65, sd: 65}},
  'Lapras': {bs: {at: 75, sa: 95}, otherFormes: ['Lapras-Mega']},
  'Larvesta': {bs: {hp: 75, sa: 85, sp: 70}},
  'Leavanny': {bs: {at: 110, sd: 70}, abilities: {0: 'Sharpness'}},
  'Ledian': {bs: {hp: 70, at: 65, sa: 85}, abilities: {0: 'Huge Power'}},
  'Ledyba': {bs: {at:40, sa: 60}},
  'Lickitung': {abilities: {0: 'Gooey'}},
  'Lickilicky': {abilities: {0: 'Gooey'}},
  'Liepard': {bs: {hp: 70, at: 110, df: 60, sd: 60, sp: 120}},
  'Linoone': {bs: {hp: 80}, otherFormes: ['Linoone-Galar']},
  'Linoone-Galar': {bs: {hp: 80}},
  'Litwick': {bs: {at: 50, sd: 65}},
  'Lokix': {bs: {at: 112}},
  'Lopunny': {types: ['Normal', 'Fighting'], bs: {at: 106}},
  'Loudred': {bs: {at: 80, sa: 80}},
  'Ludicolo': {bs: {at: 80}},
  'Lumineon': {bs: {hp: 79, sa: 100}},
  'Lunatone': {bs: {df: 70, sa: 115, sd: 90}},
  'Lurantis': {abilities: {0: 'Adaptability'}},
  'Luvdisc': {types: ['Water', 'Fairy'], bs: {hp: 63, sa: 110, sp: 100}},
  'Luxio': {bs: {sa:65, sp: 80}},
  'Luxray': {bs: {df: 75, sa: 75, sd: 75, sp: 100}, abilities: {0: 'Strong Jaw'}},
  'Machamp': {otherFormes: ['Machamp-Mega']},
  'Magcargo': {bs: {hp: 70, df: 140, sa: 100}, abilities: {0: 'Gooey'}},
  'Malamar': {bs: {at: 100, sd: 85}},
  'Maractus': {bs: {df: 77, sd: 77}},
  'Marowak': {bs: {sp: 65}},
  'Masquerain': {types: ['Bug', 'Water'], bs: {sd: 90}},
  'Maushold': {bs: {at: 85}},
  'Mawile': {bs: {hp: 65}},
  'Meganium': {types: ['Grass', 'Fairy'], bs: {sa: 90}},
  'Meowth': {bs: {at:65}},
  ...
  'Mime Jr.': {bs: {hp: 60, sa: 90, sp: 90}},
  'Mr. Mime': {bs: {hp: 50}, otherFormes: ['Mr. Mime-Galar']},
  'Mr. Mime-Galar': {bs: {hp: 50}},
  'Morelull': {bs: {hp: 55}},
  'Morgrem': {bs: {sa: 55, sd: 70}},
  'Morpeko': {bs: {at: 110}},
  'Morpeko-Hangry': {bs: {at: 110}},
  'Mothim': {bs: {at: 84, df: 60, sa: 105, sd: 70, sp: 86}},
  'Naganadel': {bs: {sa: 117}},
  'Nickit': {bs: {sa: 48}},
  'Nidoqueen': {bs: {at: 82}},
  'Nidoking': {bs: {at: 92}},
  'Nihilego': {bs: {hp: 99, sa: 117, sd: 111, sp: 93}},
  'Noctowl': {bs: {sa: 95, df: 65}},
  'Nintetales': {bs: {sa: 100}},
  'Noibat': {bs: {hp: 60, at: 65, df: 55, sa: 65, sd: 50, sp: 80}},
  'Noivern': {bs: {sa: 102}},
  'Nuzleaf': {bs: {df: 50, sd: 50, sp: 90}},
  'Obstagoon': {bs: {at: 95}},
  'Onix': {bs: {hp: 55, at: 60}},
  'Okidogi': {bs: {sd: 80}},
  'Orbeetle': {otherFormes: ['Orbeetle-Mega']},
  'Overqwil': {bs: {hp: 95, df: 100, sa: 55, sd: 80}},
  'Pachirisu': {bs: {sa: 90, sp: 115}, abilities: {0: 'Fur Coat'}},
  'Pansage': {bs: {at: 60}},
  'Pansear': {bs: {sa: 60}},
  'Panpour': {bs: {sa: 60}},
  'Paras': {bs: {hp: 65}},
  'Parasect': {bs: {hp: 95, at: 100, sd: 90}},
  'Pelipper': {bs: {hp: 80}},
  'Persian': {bs: {hp: 75, at: 105, sa: 85}},
  'Pheromosa': {bs: {at: 127, sa: 117, sp: 131}},
  'Pidgey': {bs: {at: 50, sa: 45}},
  'Pidgeotto': {bs: {at: 83, sa: 75, sp: 81}},
  'Pidgeot': {bs: {at: 95, sa: 105, sp: 100}},
  'Pidove': {bs: {at: 36, sa: 55}},
  'Pignite': {types: ['Fire', 'Dark']},
  'Pikachu': {bs: {df: 30, sd: 40}, otherFormes: ['Pikachu-Amarillo', 'Pikachu-Mega']},
  'Pikachu-Amarillo': {bs: {hp: 55, at: 75, df: 50, sa: 70, sd: 60, sp: 110}, abilities: {0: 'Sobrecarga'}},
  'Pikachu-Mega': {bs: {hp: 55, at: 135, df: 100, sa: 130, sd: 100, sp: 110}, abilities: {0: 'Sobrecarga'}},
  'Pincurchin': {abilities: {0: 'Electric Surge'}},
  'Plusle': {bs: {sa: 105}},
  'Poliwag': {bs: {hp: 55, at: 60, sa: 55, sd: 50, sp: 75}},
  'Poliwhirl': {bs: {at: 80, sa: 65, sd: 55, sp: 80}},
  'Ponyta': {abilities: {0: 'Reckless'}},
  'Primeape': {bs: {at: 115, sp: 105}, abilities: {0: 'Acometida'}},
  'Pumpkaboo-Small': {bs: {hp: 59, sp: 41}},
  'Psyduck': {bs: {hp: 60}},
  'Purugly': {bs: {hp: 85, at: 102}},
  'Pyroar': {bs: {sa: 115}},
  'Quagsire': {bs: {at: 100, df: 95}},
  'Quilladin': {bs: {hp: 71}},
  'Quilava': {types: ['Fire', 'Normal']},
  'Raichu': {bs: {sp: 100}},
  'Rampardos': {bs: {sp: 68}},
  'Rapidash': {bs: {hp: 85, at: 110}, abilities: {0: 'Reckless'}},
  'Raticate': {bs: {hp: 65, at: 100, sp: 110}},
  'Raticate-Alola': {bs: {at: 86}},
  'Relicanth': {bs: {at: 100}},
  'Rellor': {bs: {hp: 51, sp: 40}},
  'Revavroom': {bs: {sp: 100}},
  ...
  'Samurott': {types: ['Water', 'Fighting'], bs: {at: 108, sa: 100}},
  'Samurott-Hisui': {bs: {at: 118, sa: 90}},
  'Sandaconda': {otherFormes: ['Sandaconda-Mega']},
  'Sandslash': {bs: {at: 110, sp: 70}},
  'Sandslash-Alola': {bs: {at: 110}, abilities: {0: 'Slush Rush'}},
  'Sawsbuck': {bs: {at: 115, sp: 105}},
  'Sceptile': {types: ['Grass', 'Dragon'], bs: {at: 105, sa: 85}},
  'Sceptile-Mega': {bs: {hp: 70, at: 145, df: 75, sa: 110, sd: 85, sp:145}, abilities: {0: 'Silvano'}},
  'Scovillain': {bs: {sp: 95}},
  'Seaking': {bs: {at: 110, df: 75, sp: 80}},
  'Seedot': {bs: {hp: 50, at: 55, sa: 50, sd: 50, sp: 55}},
  'Seismitoad': {bs: {sa: 90}},
  'Sentret': {bs: {at: 66, sp: 70}},
  'Serperior': {types: ['Grass', 'Psychic'], bs: {at: 85, sa: 85}},
  'Servine': {bs: {at: 70, sa: 70}},
  'Seviper': {bs: {hp: 83, at: 110, df: 70, sa: 90}, abilities: {0: 'Merciless'}},
  'Sharpedo': {bs: {df: 50, sa: 90, sd: 50, sp: 100}},
  'Shellder': {bs: {sa: 50, sp: 50}},
  'Shiftry': {bs: {at: 110, sa: 95, sp: 90}},
  'Shiinotic': {bs: {hp: 75, at: 55}},
  'Shinx': {bs: {sp: 65}},
  'Sinistea': {bs: {sd: 50}},
  'Skiploom': {bs: {at: 65}},
  'Skitty': {bs: {at: 65, sp: 60}},
  'Skuntank': {bs: {at: 103}},
  'Slugma': {bs: {hp: 60, df: 60}, abilities: {0: 'Gooey'}},
  'Slurpuff': {bs: {at: 90, sa: 75}},
  'Snivy': {bs: {at: 50, sa: 50}},
  'Snorunt': {abilities: {0: 'Poder Gélido'}},
  'Solrock': {bs: {at: 115, df: 90, sd: 70}},
  'Spidops': {bs: {hp: 70, at: 100}, abilities:{ 0: 'Technician' }},
  'Spinarak': {bs: {sd: 50, sp: 70}},
  'Spinda': {bs: {hp: 70, at: 100, sa: 100}},
  'Spiritomb': {bs: {hp: 60}},
  'Squawkabily': {bs: {at: 106, sd: 61, sp: 102}},
  'Stakataka': {bs: {at: 121, df: 181, sd: 91}},
  'Steelix': {bs: {at: 100}, otherFormes: ['Steelix-Mega']},
  'Steelix-Mega': {bs: {hp: 75, at: 125, df: 230, sa: 55, sd: 95, sp:30}, abilities: {0: 'Sheer Force'}},
  'Steenee': {bs: {at: 60, sa: 60}},
  'Sudowoodo': {bs: {hp: 80, df: 120, sa: 50, sd: 75, sp: 50}},
  'Sunflora': {types: ['Grass', 'Fire'], bs: {sa: 115, df: 65, sd: 95}, abilities: {0: 'Grassy Surge'}},
  'Sunkern': {bs: {at: 50, sa: 50}},
  'Surskit': {bs: {hp: 55, sa: 60, sd: 60}},
  'Swablu': {bs: {at: 60, sa: 60}},
  'Swalot': {bs: {sa: 80}, abilities: {0: 'Corrosion'}},
  'Swanna': {bs: {sa: 107}, abilities: {0: 'Liquid Voice'}},
  'Swellow': {bs: {hp: 75, at: 105, sa: 50}},
  'Swoobat': {bs: {at: 67, sa: 100, sd: 65}},
  'Tailow': {bs: {at: 65}},
  'Talonflame': {bs: {at: 90}},
  'Tatsugiri': {bs: {sp: 92}},
  'Tauros': {bs: {at: 110}},
  ...
  'Tinkaton': {bs: {at: 90}},
  'Torkoal': {bs: {sa: 95}},
  'Toxel': {bs: {sa: 35, sd: 40}},
  'Toxicroak': {bs: {sp: 90}},
  'Toxtricity': {otherFormes: ['Toxtricity-Low-Key', 'Toxtricity-Mega']},
  'Tranquill': {bs: {at: 50, sa: 77}},
  'Trevenant': {bs: {df: 86}},
  'Tropius': {bs: {at: 90, df: 93, sa: 90}},
  'Trubbish': {bs: {hp: 65, sa: 50}},
  'Tsareena': {abilities: {0: 'Camorrista'}},
  'Typhlosion': {types: ['Fire', 'Normal'], bs: {at: 74, sp: 110}},
  'Tyrogue': {bs: {hp: 55, at: 60, df: 60, sd: 45, sp: 65}},
  'Unfezant': {bs: {at: 65, sa: 115}},
  'Unown': {bs: {at: 48, sa: 96, sp: 96}},
  'Ursaring': {bs: {at: 110, df: 65, sd: 65}},
  'Vanillite': {types: ['Ice', 'Fairy']},
  'Vanillish': {types: ['Ice', 'Fairy']},
  'Vanilluxe': {types: ['Ice', 'Fairy'], bs: {at: 75, sa: 130}},
  'Veluza': {bs: {at:112, sp: 100}},
  'Venonat': {bs: {sa: 60}},
  'Venomoth': {bs: {sd: 90, sa: 100}},
  'Venusaur': {otherFormes: ['Venusaur-Mega-X', 'Venusaur-Mega-Y']},
  'Venusaur-Mega-X': {types: ['Grass', 'Poison'], bs: {hp: 80, at: 100, df: 123, sa: 122, sd: 120, sp: 80}, abilities: {0: 'Thick Fat'}},
  'Venusaur-Mega-Y': {types: ['Grass', 'Poison'], bs: {hp: 80, at: 92, df: 103, sa: 130, sd: 150, sp: 70}, abilities: {0: 'Raíz Robusta'}},
  'Vespiquen': {bs: {at: 90, sa: 70}},
  'Victreebel': {bs: {at: 110, df: 70, sa: 95}},
  'Vileplume': {bs: {sd: 95}},
  'Vivillon': {bs: {sa: 105, sd: 90}},
  'Volbeat': {types: ['Bug', 'Electric'], bs: {at: 53, df: 55, sa: 100, sd: 75, sp: 105}},
  'Voltorb': {abilities: {0: 'Electric Surge'}},
  'Vulpix': {bs: {sa: 60}},
  'Wailord': {bs: {at: 80, df: 65, sd: 65}},
  'Walrein': {bs: {at: 90}},
  'Watchog': {bs: {hp: 70, at: 95, sp: 110}},
  'Weavile': {abilities: {0: 'Inner Focus'}},
  'Weedle': {bs: {at: 45}},
  'Weezing': {bs: {sa: 95}},
  'Whimsicott': {bs: {sa: 97}},
  'Whiscash': {bs: {at: 95, sd: 81}},
  'Whismur': {bs: {at: 60, df: 36, sd: 36}},
  'Wigglytuff': {bs: {at: 65, df: 60, sd: 60}},
  'Woobat': {bs: {hp: 55}},
  ...
  'Alcremie-Mega': {
    types: ['Fairy'],
    abilities: {0: 'Regenerator'},
    bs: {hp: 65, at: 80, df: 105, sa: 130, sd: 151, sp: 64},
    weightkg: 5,
    baseSpecies: 'Alcremie',
  },
  'Appletun-Mega': {
    types: ['Grass', 'Dragon'],
    bs: {hp: 110, at: 105, df: 100, sa: 120, sd: 100, sp: 50},
    weightkg: 13,
    abilities: {0: 'Thick Fat'},
    baseSpecies: 'Appletun',
  },
  'Butterfree-Mega': {
    types: ['Bug', 'Flying'],
    bs: {hp: 60, at: 55, df: 70, sa: 120, sd: 130, sp: 110},
    weightkg: 32,
    abilities: {0: 'Compound Eyes'},
    baseSpecies: 'Butterfree',
  },
  'Centiskorch-Mega': {
    types: ['Fire', 'Bug'],
    abilities: {0: 'Blaze'},
    bs: {hp: 100, at: 145, df: 95, sa: 100, sd: 90, sp: 95},
    weightkg: 120,
    baseSpecies: 'Centiskorch',
  },
  'Coalossal-Mega': {
    types: ['Rock', 'Fire'],
    abilities: {0: 'Flame Body'},
    bs: {hp: 110, at: 110, df: 140, sa: 110, sd: 110, sp: 30},
    weightkg: 310.5,
    baseSpecies: 'Coalossal',
  },
  'Corviknight-Mega': {
    types: ['Flying', 'Steel'],
    bs: {hp: 98, at: 117, df: 125, sa: 73, sd: 95, sp: 87},
    weightkg: 120,
    abilities: {0: 'Reckless'},
    baseSpecies: 'Corviknight',
  },
  'Copperajah-Mega': {
    types: ['Steel'],
    bs: {hp: 122, at: 150, df: 99, sa: 80, sd: 69, sp: 80},
    weightkg: 650,
    abilities: {0: 'Sheer Force'},
    baseSpecies: 'Copperajah',
  },
  ...
  'Duraludon-Mega': {
    types: ['Steel', 'Dragon'],
    bs: {hp: 70, at: 115, df: 135, sa: 140, sd: 70, sp: 105},
    weightkg: 600,
    abilities: {0: 'Clear Body'},
    baseSpecies: 'Duraludon',
  },
  'Flapple-Mega': {
    types: ['Grass', 'Dragon'],
    bs: {hp: 110, at: 125, df: 100, sa: 100, sd: 100, sp: 50},
    weightkg: 1,
    abilities: {0: 'Hustle'},
    baseSpecies: 'Flapple',
  },
  ...
  'Kingler-Mega': {
    types: ['Water'],
    bs: {hp: 75, at: 170, df: 135, sa: 70, sd: 75, sp: 75},
    weightkg: 150,
    abilities: {0: 'Tough Claws'},
    baseSpecies: 'Kingler',
  },
  'Lapras-Mega': {
    types: ['Water', 'Ice'],
    bs: {hp: 130, at: 95, df: 100, sa: 125, sd: 105, sp: 80},
    weightkg: 220,
    abilities: {0: 'Refrigerate'},
    baseSpecies: 'Lapras',
  },
  'Machamp-Mega': {
    ...
    bs: {hp: 90, at: 160, df: 100, sa: 75, sd: 95, sp: 75},
    weightkg: 130,
    baseSpecies: 'Machamp',
  },
  'Orbeetle-Mega': {
    types: ['Bug', 'Psychic'],
    bs: {hp: 60, at: 65, df: 130, sa: 110, sd: 140, sp: 100},
    weightkg: 40.8,
    abilities: {0: 'Neuroforce'},
    baseSpecies: 'Orbeetle',
  },
  'Sandaconda-Mega': {
    types: ['Ground'],
    bs: {hp: 72, at: 137, df: 125, sa: 75, sd: 80, sp: 131},
    weightkg: 65.5,
    abilities: {0: 'Sand Stream'},
    baseSpecies: 'Sandaconda',
  },
  ...
  'Toxtricity-Mega': {
    types: ['Electric', 'Poison'],
    bs: {hp: 75, at: 118, df: 90, sa: 144, sd: 80, sp: 95},
    weightkg: 40,
    abilities: {0: 'Download'},
    baseSpecies: 'Toxtricity',
  },
  'Dragonite-Mega':{
    bs: {hp: 91, at: 154, df: 105, sa: 120, sd: 110, sp: 120},
    weightkg: 290,
    abilities: {0: 'Multiscale'},
...
const SV: {[name: string]: SpeciesData} = extend(true, {}, SS, SV_PATCH, PLA_PATCH, ANIL_PATCH);
